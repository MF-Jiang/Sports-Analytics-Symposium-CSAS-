...
if __name__ == '__main__':
    data=pd.read_csv('../data/event_prediction_dataset/event_prediction_dataset_V3.csv', low_memory=False)
    ...
    data_parallelized.to_csv("../data/event_prediction_dataset/event_prediction_dataset_V4.csv", index=False)
    print("save v3")
