...
file_path = "../data/batter_prediction_dataset/batter_prediction_dataset.csv"
...
data.to_csv("../data/batter_prediction_dataset/batter_prediction_dataset_V2.csv", index=False)
print("save v2")
...
data.to_csv("../data/batter_prediction_dataset/batter_prediction_dataset_V3.csv", index=False)
